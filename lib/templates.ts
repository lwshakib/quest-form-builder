...
export const TEMPLATES: Template[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      { title: "How many people are coming with you?", type: "SHORT_TEXT" },
      {
        ...
        type: "CHECKBOXES",
        options: ["Appetizer", "Main dish", "Dessert", "Drinks", "Other"],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    questions: [
      ...
      {
        title: "Can we contact you about your feedback?",
        type: "MULTIPLE_CHOICE",
        options: ["Yes", "No"],
      },
    ],
  ...
  },
  {
    ...
    questions: [
      ...
      {
        title: "What is one thing you learned today?",
        type: "PARAGRAPH",
        required: true,
      },
      {
        title: "What was the most challenging part of the lesson?",
        type: "PARAGRAPH",
      },
    ...
    questions: [
      {
        title: "Course Rating",
        type: "MULTIPLE_CHOICE",
        options: ["5 - Excellent", "4", "3", "2", "1 - Poor"],
        required: true,
      },
      { title: "What did you like most about the course?", type: "PARAGRAPH" },
      {
        ...
        type: "MULTIPLE_CHOICE",
        options: ["Outstanding", "Good", "Adequate", "Needs improvement"],
      },
    ],
  },
];
