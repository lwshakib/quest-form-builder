            ...
            <div className="mx-auto max-w-7xl px-6">
              <div className="text-center sm:mx-auto lg:mt-0 lg:mr-auto">
                ...
                <TextEffect
                  ...
                  delay={0.5}
                  as="p"
                  className="text-muted-foreground mx-auto mt-8 max-w-2xl text-lg font-medium text-balance"
                >
                  Create interactive quests, sophisticated forms, and personalized surveys in
                  seconds. The most powerful way to engage your audience.
                </TextEffect>
