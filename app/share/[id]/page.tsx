            ...
            <div className="relative border border-border/50 bg-background rounded-lg overflow-hidden transition-all duration-300 shadow-sm">
              ...
              <div className="p-8 sm:p-10 space-y-4 relative z-10">
                <div className="space-y-2">
                  ...
                  {quest.description && (
                    <p className="text-lg text-muted-foreground/70 font-medium leading-relaxed max-w-xl">
                      {quest.description}
                    </p>
                  )}
                </div>
            ...
            {quest.questions.map((q: any) => (
              ...
              >
                ...
                <div className="p-6 sm:p-8 space-y-6 relative z-10">
                  <div className="space-y-4">
                    <div className="space-y-2">
                      <Label className="text-xl sm:text-2xl font-bold tracking-tight block">
                        {q.title}
                        {q.required && (
                      ...
                      >
                        {(q.options as string[] || []).map((option) => (
                          ...
                          >
                            ...
                            <span className="text-base font-medium text-foreground/80">{option}</span>
                          </Label>
                        ))}
                      </RadioGroup>
                    )}
          ...
          <footer className="pt-12 space-y-16">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
              <Button 
                ...
                className="h-12 px-10 rounded-full font-bold shadow-lg shadow-primary/10 hover:shadow-xl transition-all order-2 sm:order-1 w-full sm:w-auto"
              >
                {isSubmitting ? (
