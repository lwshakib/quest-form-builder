  ...
  return (
    <div className="grid min-h-svh lg:grid-cols-2">
      <div className="bg-muted relative hidden overflow-hidden lg:block">
        ...
        <div className="absolute inset-x-0 bottom-0 z-20 bg-linear-to-t from-black/80 via-black/40 to-transparent p-12 text-left">
          <motion.div
          ...
          >
            ...
            <p className="max-w-sm text-lg text-white/70">
              Expereince the most powerful and flexible form builder designed for modern product
              teams.
            </p>
          </motion.div>
        </div>
